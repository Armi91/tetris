...
const BlockrainThemes = {
  ...
  'segro': {
    background: '#ffffff',
    complexBlocks: {
      line: ['./assets/blockrain/blocks/line.png'],
      square: ['./assets/blockrain/blocks/square.png'],
      arrow: './assets/blockrain/blocks/arrow.png',
      rightHook: ['./assets/blockrain/blocks/rightHook.png'],
      leftHook: './assets/blockrain/blocks/leftHook.png',
      rightZag: ['./assets/blockrain/blocks/rightZag.png'],
      leftZag: './assets/blockrain/blocks/leftZag.png'
    }
  }
};
...
export class BlockrainService {

  score = new BehaviorSubject(0);
  pause = new BehaviorSubject(false);
  nextShape = new BehaviorSubject('');
  ...
  initBlockrain() {
    ...
    (function (e) { 'function' === typeof define && define.amd ? define(['jquery'], e) : e(jQuery); })(function (e) { let t = 0, i = Array.prototype.slice; e.cleanData = function (t) { return function (i) { let s, n, a; for (a = 0; null != (n = i[a]); a++) {try { s = e._data(n, 'events'), s && s.remove && e(n).triggerHandler('remove'); } catch (o) { } } t(i); }; }(e.cleanData), e.widget = function (t, i, s) { let n, a, o, r, h = {}, l = t.split('.')[0]; return t = t.split('.')[1], n = l + '-' + t, s || (s = i, i = e.Widget), e.expr[':'][n.toLowerCase()] = function (t) { return !!e.data(t, n); }, e[l] = e[l] || {}, a = e[l][t], o = e[l][t] = function (e, t) { return this._createWidget ? (arguments.length && this._createWidget(e, t), void 0) : new o(e, t); }, e.extend(o, a, { version: s.version, _proto: e.extend({}, s), _childConstructors: [] }), r = new i, r.options = e.widget.extend({}, r.options), e.each(s, function (t, s) { return e.isFunction(s) ? (h[t] = function () { const e = function () { return i.prototype[t].apply(this, arguments); }, n = function (e) { return i.prototype[t].apply(this, e); }; return function () { let t, i = this._super, a = this._superApply; return this._super = e, this._superApply = n, t = s.apply(this, arguments), this._super = i, this._superApply = a, t; }; }(), void 0) : (h[t] = s, void 0); }), o.prototype = e.widget.extend(r, { widgetEventPrefix: a ? r.widgetEventPrefix || t : t }, h, { constructor: o, namespace: l, widgetName: t, widgetFullName: n }), a ? (e.each(a._childConstructors, function (t, i) { const s = i.prototype; e.widget(s.namespace + '.' + s.widgetName, o, i._proto); }), delete a._childConstructors) : i._childConstructors.push(o), e.widget.bridge(t, o), o; }, e.widget.extend = function (t) { for (let s, n, a = i.call(arguments, 1), o = 0, r = a.length; r > o; o++) {for (s in a[o]) { n = a[o][s], a[o].hasOwnProperty(s) && void 0 !== n && (t[s] = e.isPlainObject(n) ? e.isPlainObject(t[s]) ? e.widget.extend({}, t[s], n) : e.widget.extend({}, n) : n); } } return t; }, e.widget.bridge = function (t, s) { const n = s.prototype.widgetFullName || t; e.fn[t] = function (a) { let o = 'string' === typeof a, r = i.call(arguments, 1), h = this; return a = !o && r.length ? e.widget.extend.apply(null, [a].concat(r)) : a, o ? this.each(function () { let i, s = e.data(this, n); return 'instance' === a ? (h = s, !1) : s ? e.isFunction(s[a]) && '_' !== a.charAt(0) ? (i = s[a].apply(s, r), i !== s && void 0 !== i ? (h = i && i.jquery ? h.pushStack(i.get()) : i, !1) : void 0) : e.error('no such method \'' + a + '\' for ' + t + ' widget instance') : e.error('cannot call methods on ' + t + ' prior to initialization; ' + 'attempted to call method \'' + a + '\''); }) : this.each(function () { const t = e.data(this, n); t ? (t.option(a || {}), t._init && t._init()) : e.data(this, n, new s(a, this)); }), h; }; }, e.Widget = function () { }, e.Widget._childConstructors = [], e.Widget.prototype = { widgetName: 'widget', widgetEventPrefix: '', defaultElement: '<div>', options: { disabled: !1, create: null }, _createWidget: function (i, s) { s = e(s || this.defaultElement || this)[0], this.element = e(s), this.uuid = t++ , this.eventNamespace = '.' + this.widgetName + this.uuid, this.bindings = e(), this.hoverable = e(), this.focusable = e(), s !== this && (e.data(s, this.widgetFullName, this), this._on(!0, this.element, { remove: function (e) { e.target === s && this.destroy(); } }), this.document = e(s.style ? s.ownerDocument : s.document || s), this.window = e(this.document[0].defaultView || this.document[0].parentWindow)), this.options = e.widget.extend({}, this.options, this._getCreateOptions(), i), this._create(), this._trigger('create', null, this._getCreateEventData()), this._init(); }, _getCreateOptions: e.noop, _getCreateEventData: e.noop, _create: e.noop, _init: e.noop, destroy: function () { this._destroy(), this.element.unbind(this.eventNamespace).removeData(this.widgetFullName).removeData(e.camelCase(this.widgetFullName)), this.widget().unbind(this.eventNamespace).removeAttr('aria-disabled').removeClass(this.widgetFullName + '-disabled ' + 'ui-state-disabled'), this.bindings.unbind(this.eventNamespace), this.hoverable.removeClass('ui-state-hover'), this.focusable.removeClass('ui-state-focus'); }, _destroy: e.noop, widget: function () { return this.element; }, option: function (t, i) { let s, n, a, o = t; if (0 === arguments.length) { return e.widget.extend({}, this.options); } if ('string' === typeof t) { if (o = {}, s = t.split('.'), t = s.shift(), s.length) { for (n = o[t] = e.widget.extend({}, this.options[t]), a = 0; s.length - 1 > a; a++) {n[s[a]] = n[s[a]] || {}, n = n[s[a]]; } if (t = s.pop(), 1 === arguments.length) { return void 0 === n[t] ? null : n[t]; } n[t] = i; } else { if (1 === arguments.length) { return void 0 === this.options[t] ? null : this.options[t]; } o[t] = i; } } return this._setOptions(o), this; }, _setOptions: function (e) { let t; for (t in e) { this._setOption(t, e[t]); } return this; }, _setOption: function (e, t) { return this.options[e] = t, 'disabled' === e && (this.widget().toggleClass(this.widgetFullName + '-disabled', !!t), t && (this.hoverable.removeClass('ui-state-hover'), this.focusable.removeClass('ui-state-focus'))), this; }, enable: function () { return this._setOptions({ disabled: !1 }); }, disable: function () { return this._setOptions({ disabled: !0 }); }, _on: function (t, i, s) { let n, a = this; 'boolean' !== typeof t && (s = i, i = t, t = !1), s ? (i = n = e(i), this.bindings = this.bindings.add(i)) : (s = i, i = this.element, n = this.widget()), e.each(s, function (s, o) { function r() { return t || a.options.disabled !== !0 && !e(this).hasClass('ui-state-disabled') ? ('string' === typeof o ? a[o] : o).apply(a, arguments) : void 0; } 'string' !== typeof o && (r.guid = o.guid = o.guid || r.guid || e.guid++); const h = s.match(/^([\w:-]*)\s*(.*)$/), l = h[1] + a.eventNamespace, u = h[2]; u ? n.delegate(u, l, r) : i.bind(l, r); }); }, _off: function (t, i) { i = (i || '').split(' ').join(this.eventNamespace + ' ') + this.eventNamespace, t.unbind(i).undelegate(i), this.bindings = e(this.bindings.not(t).get()), this.focusable = e(this.focusable.not(t).get()), this.hoverable = e(this.hoverable.not(t).get()); }, _delay: function (e, t) { function i() { return ('string' === typeof e ? s[e] : e).apply(s, arguments); } const s = this; return setTimeout(i, t || 0); }, _hoverable: function (t) { this.hoverable = this.hoverable.add(t), this._on(t, { mouseenter: function (t) { e(t.currentTarget).addClass('ui-state-hover'); }, mouseleave: function (t) { e(t.currentTarget).removeClass('ui-state-hover'); } }); }, _focusable: function (t) { this.focusable = this.focusable.add(t), this._on(t, { focusin: function (t) { e(t.currentTarget).addClass('ui-state-focus'); }, focusout: function (t) { e(t.currentTarget).removeClass('ui-state-focus'); } }); }, _trigger: function (t, i, s) { let n, a, o = this.options[t]; if (s = s || {}, i = e.Event(i), i.type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), i.target = this.element[0], a = i.originalEvent) { for (n in a) { n in i || (i[n] = a[n]); } } return this.element.trigger(i, s), !(e.isFunction(o) && o.apply(this.element[0], [i].concat(s)) === !1 || i.isDefaultPrevented()); } }, e.each({ show: 'fadeIn', hide: 'fadeOut' }, function (t, i) { e.Widget.prototype['_' + t] = function (s, n, a) { 'string' === typeof n && (n = { effect: n }); let o, r = n ? n === !0 || 'number' === typeof n ? i : n.effect || i : t; n = n || {}, 'number' === typeof n && (n = { duration: n }), o = !e.isEmptyObject(n), n.complete = a, n.delay && s.delay(n.delay), o && e.effects && e.effects.effect[r] ? s[t](n) : r !== t && s[r] ? s[r](n.duration, n.easing, a) : s.queue(function (i) { e(this)[t](), a && a.call(s[0]), i(); }); }; }), e.widget; });
    ((function ($) {
      ...
      $.widget('aerolab.blockrain', {
        ...
        options: {
          ...
          // Copy
          playText: 'Zagraj <br> w magazynową układankę',
          ...
          if (this._theme.backgroundGrid instanceof Image) {
            ...
            for (let x = 0; x < this._BLOCK_WIDTH; x++) {
              for (let y = 0; y < this._BLOCK_HEIGHT; y++) {
                const cx = x * this._block_size;
                const cy = y * this._block_size;
            ...
            const borderWidth = this._theme.strokeWidth;
            const borderDistance = Math.round(this._block_size * 0.23);
            const squareDistance = Math.round(this._block_size * 0.30);
        ...
        _SetupShapeFactory: function () {
          ...
          function Shape(game, orientations, symmetrical, blockType): any {
            ...
            $.extend(this, {
              ...
              rotate: function (direction) {
                ...
                if (!game._checkCollisions(
                  ...
                  const ogOrientation = this.orientation;
                  const ogX = this.x;
                  const ogY = this.y;
              ...
              getBounds: function (_blocks) { // _blocks can be an array of blocks, an orientation index, or undefined
                let blocks = $.isArray(_blocks) ? _blocks : this.getBlocks(_blocks),
        ...
        _SetupFilled: function () {
          ...
          this._filled = {
            ...
            checkForClears: function () {
              const startLines = game._board.lines;
              ...
              const clearedLines = game._board.lines - startLines;
              this._updateScore(clearedLines);
            },
            _updateScore: function (numLines) {
              if (numLines <= 0) { return; }
              const scores = [0, 300, 500, 700, 1000];
              if (numLines >= scores.length) { numLines = scores.length - 1; }

              this.score += scores[numLines];
              game.options.level.scoreInLevel += scores[numLines];
              
              if (game.options.level.scoreInLevel >= 1000) {
                game.options.level.scoreInLevel = 0;
                game.options.level.current++;
                srvc.level.next(game.options.level.current);
              }
              game._$scoreText.text(this.score);
              srvc.score.next(this.score);
        ...
        _SetupBoard: function () {
          ...
          this._board = {
            ...
            animateDelay: 1000 / ((game.options.speed * game.options.level.current) / 5),
            ...
            nextShape: function (_set_next_only) {
              ...
              // @ts-ignore
                ...
                shape.init();
                this.next = shape;
                srvc.nextShape.next(this.next.blockType);
            ...
            animate: function () {
              ...
              if (!this.paused && !this.gameover) {
                ...
                if (drop) {
                  const cur = this.cur, x = cur.x, y = cur.y, blocks = cur.getBlocks();
              ...
              if (gameOver) {
                ...
                // Update the speed
                this.animateDelay = 1000 / (game.options.speed * game.options.level.current);
            ...
            drawBlock: function (x, y, blockType, blockVariation, blockIndex, blockRotation, falling) {
              ...
              const borderWidth = game._theme.strokeWidth;
              const borderDistance = Math.round(game._block_size * 0.23);
              const squareDistance = Math.round(game._block_size * 0.30);

              const color = this.getBlockColor(blockType, blockVariation, blockIndex, falling);
              ...
              if (color instanceof Image) {
                ...
                if (typeof game._theme.blocks !== 'undefined' && game._theme.blocks !== null) {
                  ...
                  const getCustomBlockImageCoordinates = function (image, blockType, blockIndex) {
                    ...
                    const positions = game._shapes[blockType][0];
                    // Find the number of tiles it should have
                    const minX = Math.min(positions[0], positions[2], positions[4], positions[6]);
                    const maxX = Math.max(positions[0], positions[2], positions[4], positions[6]);
                    const minY = Math.min(positions[1], positions[3], positions[5], positions[7]);
                    const maxY = Math.max(positions[1], positions[3], positions[5], positions[7]);
                    const rangeX = maxX - minX + 1;
                    const rangeY = maxY - minY + 1;

                    // X and Y sizes should match. Should.
                    const tileSizeX = image.width / rangeX;
                    const tileSizeY = image.height / rangeY;
                  ...
                  const coords = getCustomBlockImageCoordinates(color, blockType, blockIndex);
            ...
            getBlockColor: function (blockType, blockVariation, blockIndex, falling) {
              ...
              const getBlockVariation = function (blockTheme, blockVariation) {
        ...
        _preloadThemeAssets: function () {
          ...
          const hexColorcheck = new RegExp('^#[A-F0-9+]{3,6}', 'i');
          const base64check = new RegExp('^data:image/(png|gif|jpg);base64,', 'i');
          ...
          if (typeof this._theme.complexBlocks !== 'undefined') {
            const keys = Object.keys(this._theme.complexBlocks);
            ...
            const keys = Object.keys(this._theme.blocks);
          ...
          if (typeof this._theme.backgroundGrid !== 'undefined') {
            if (typeof this._theme.backgroundGrid === 'string') {
              if (!hexColorcheck.test(this._theme.backgroundGrid)) {
                const src = this._theme.backgroundGrid;
        ...
        _createUI: function () {
          ...
          game._$start = $(
            ...
            '<a class="blockrain-btn blockrain-start-btn button">' + this.options.playButtonText + '</a>' +
        ...
        _createControls: function () {
          ...
          game._$touchRotateLeft = $('<a class="blockrain-touch blockrain-touch-rotate-left" />').appendTo(game._$gameholder).hide();
          // game._$touchDrop = $('<a class="blockrain-touch blockrain-touch-drop" />').appendTo(game._$gameholder);

          game._$touchLeft = $('#touchLeft');
          game._$touchRight = $('#touchRight');
          game._$touchRotateRight = $('#touchRotate');
          game._$touchDrop = $('#touchDrop');
        ...
        _getNiceShapes: function () {
          ...
          for (const attr in this._shapeFactory) {
          ...
          const func = function (filled, checkCollisions, width, height, mode, _one_shape) {
            ...
            // for each shape...
            const opts = _one_shape === undefined ? shapes : { cur: _one_shape }; // BOO
        ...
        _setupControls: function (enable) {
          ...
          function isStopKey(evt) {
            ...
            const isStop = (cfg.stopKeys[evt.keyCode] || (cfg.moreStopKeys && cfg.moreStopKeys[evt.keyCode]));
        ...
        _setupTouchControls: function (enable) {
          ...
          if (!game.options.autoplay && enable) {
            ...
            // game._$touchRotateLeft.show().bind('touchstart click', rotateLeft).hide()
